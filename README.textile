...
Then just run @sidekick@ in your terminal.
...
You should "read the annotated source code":http://github.com/jbe/sidekick/tree/master/annotated/lib/sidekick.html.
...
* "triggers":http://github.com/jbe/sidekick/blob/master/lib/sidekick/triggers.rb

*"helpers":http://github.com/jbe/sidekick/blob/master/lib/sidekick/helpers.rb.
...
Have a look at the "existing triggers":http://github.com/jbe/sidekick/blob/master/lib/sidekick/triggers.rb, and you will get the idea. Basically, you define new triggers by calling @Sidekick::Triggers.register(:trigger_name) { .. }@, and hooking into EventMachine the same way as in @EM.run { .. }@ from there.
