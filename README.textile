...
The main code is approx 100 lines including documentation, excluding triggers and helpers.
...
Sidekick is easy to extend. To add more helpers, simply add methods to @Sidekick::Helpers@. To add triggers, use @Sidekick.register@. As an example, the following code implements the @watch@ trigger used above:
